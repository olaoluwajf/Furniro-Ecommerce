  ...
  return (
    <div>
        ...
        <div className='m-4 justify-center'>
            ...
            <p className='text-center font-semibold text-2xl text-amber-700'>Explore the details of {Room.name} and find your perfect fit.</p>
            <div className='w-full justify-center p-10  flex items-center mt-10 bg-white shadow-2xl'>
