    ...
    <div className="bg-amber-50 px-1 py-12">
      <div className="max-w-6xl mx-auto flex justify-between flex-col md:flex-row items-center gap-4">
        ...
        <div className="text-left">
          ...
          <Link
            to="/shop"
            className="rounded text-sm bg-amber-600 text-white font-bold border-[1px] hover:bg-amber-700 px-4 py-3 sm:px-4 md:px-6 lg:px-8 xl:px-10 sm:text-sm sm:py-4 cursor-pointer"
          >
            Explore More
          </Link>
        </div>
