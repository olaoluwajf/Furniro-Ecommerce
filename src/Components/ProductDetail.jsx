  ...
  return (
    <div className='py-15'>
      <div className='flex flex-row p-10 gap-3 m-0 bg-amber-100 items-center '>
        ...
        <FaGreaterThan className='text-[11px] text-'/>
        ...
        <div className='fex flex-col p-3 text-start justify-center'>
          ...
          <div className='flex flex-col py-3 gap-3'>
            ...
            <div className='flex flex-row items-center gap-1 px-3 '>
              <Link className='bg-amber-100 px-2 rounded-sm'>L</Link>
              <Link className='bg-amber-50 px-2 rounded-sm'>XL</Link>
              <Link className='bg-amber-50 px-2 rounded-sm'>XS</Link>
            </div>
          </div>
          <div className='color gap-y-1'>
            <h1 className='py-2'>Color</h1>
            <div className='flex gap-2'>
              <span className=' bg-sky-700 p-[4px] rounded-4xl h-[30px] w-[30px]  '>  </span>
              <span className=' bg-stone-700 rounded-4xl h-[30px] w-[30px]  '> </span>
              <span className=' bg-yellow-600 p-[4px] rounded-4xl h-[30px] w-[30px]  '></span>
            </div>
          </div>
